...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0a1620" },
      { title: "HEIDI — Lucrări Subacvatice Profesionale în România" },
      { name: "description", content: "Inspecții, intervenții, sudură și reparații subacvatice realizate de scafandri industriali HEIDI. Acoperire națională, peste 30 de ani de experiență." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "HEIDI · LucrariSubacvatice.ro" },
    ],
    links: [
